<template>
    <div class="box">
      ...
      <div class="livingIndex">
          ...
          <div class="item-zhishu">
              <img src="/static/img/lifestyle_drsg.png" alt="" class="icon">
              <div class="right">
           ...
           <div class="item-zhishu">
              <img src="/static/img/lifestyle_cw.png" alt="" class="icon">
              <div class="right">
           ...
           <div class="item-zhishu">
              <img src="/static/img/lifestyle_air.png" alt="" class="icon">
              <div class="right">
           ...
           <div class="item-zhishu">
              <img src="/static/img/lifestyle_sport.png" alt="" class="icon">
              <div class="right">
           ...
           <div class="item-zhishu">
              <img src="/static/img/lifestyle_uv.png" alt="" class="icon">
              <div class="right">
